...
$output .= "//Timezone".PHP_EOL.PHP_EOL;
$output .= "date_default_timezone_set('UTC');".PHP_EOL.PHP_EOL;
$output .= PHP_EOL;
...
$output .= "//it can be the same as domain (if script is placed on website's root folder) ".PHP_EOL;
$output .= "//or it can cotain path that include subfolders, if script is located in some subfolder and not in root folder".PHP_EOL;
$output .= "define('SCRIPT_URL', \"$scriptUrl\");".PHP_EOL.PHP_EOL;
$output .= PHP_EOL;
...
$output .= "define('SUCCESS_LOGIN_REDIRECT', serialize(array( 'default' => \"$redirect_after_login\"))); ".PHP_EOL.PHP_EOL;
$output .= PHP_EOL;
...
$output .= "define('MAILER', \"$mailer\"); // available options are 'mail' for php mail() and 'smtp' for using SMTP server for sending emails".PHP_EOL.PHP_EOL;
