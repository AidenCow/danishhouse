              ...
              <div class="span9 profile-details-wrapper">
                    ...
                    <form class="form-horizontal no-submit" id="form-details">
                        ...
                        <div class="control-group form-group">
                          ...
                          <div class="controls col-lg-8">
                            <input id="first_name" name="first_name" type="text" value="<?php echo e($userDetails['first_name']); ?>" class="input-xlarge form-control">
                        ...
                        <div class="control-group form-group">
                          ...
                          <div class="controls col-lg-8">
                            <input id="last_name" name="last_name" type="text" value="<?php echo e($userDetails['last_name']); ?>" class="input-xlarge form-control">
                       ...
                       <!-- Text input-->
                        <div class="control-group form-group">
                          ...
                          <div class="controls col-lg-8">
                            <input id="address" name="address" type="text" value="<?php echo e($userDetails['address']); ?>" class="input-xlarge form-control">
                        ...
                        <div class="control-group form-group">
                          ...
                          <div class="controls col-lg-8">
                            <input id="phone" name="phone" type="text" value="<?php echo e($userDetails['phone']); ?>" class="input-xlarge form-control">
